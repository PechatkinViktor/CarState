...
public class Const {
    ...
    public static final int UNDO_TEXT = R.string.undo;
    public static final String FRAGMENT_DIALOG_PLANNED = "fragment_dialog_planned";
    public static final String FRAGMENT_DIALOG_HISTORY = "fragment_dialog_history";
    public static final int DRAG_DIRS = 0;
